    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 24),
            child: Text('Выберите, с кем хотите совершить обмен', style: Theme.of(context).textTheme.headline4),
          ),
          SizedBox(height: 20,),
          SizedBox(
            height: 70,
            child: ListView.builder(
                ...
                itemCount: 10,
                itemBuilder: (_, i) {
                  if (i == 0) return SizedBox(width: 24,);
                  return Padding(
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 24),
            child: Text('Выберите, на что хотите обменять NFT', style: Theme.of(context).textTheme.headline4),
          ),
          SizedBox(height: 20,),
          GridView.builder(
            padding: EdgeInsets.symmetric(horizontal: 24),
